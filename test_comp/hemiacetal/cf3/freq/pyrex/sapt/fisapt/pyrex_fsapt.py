...
num_ts = 99 #Hard coded number for transition state of this system, delete line to make general
num_geoms = 100 # NOTE: Use a few geometries past the transition state to get better agreement with pyrex data
