...
# Initialize empty dictionaries to hold pair energy and force(f) data
...
num_geoms = 10 #Hard coded number for transition state of this system, delete line to make general
