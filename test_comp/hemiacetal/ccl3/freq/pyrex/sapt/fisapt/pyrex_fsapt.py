...
num_ts = 129 #Hard coded number for transition state of this system, delete line to make general
num_geoms = 130 # NOTE: Use a few geometries past the transition state to get better agreement with pyrex data
